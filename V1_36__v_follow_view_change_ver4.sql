...
SELECT a.follower_id AS source_id,
   ...
   FROM follow a
     ...
     LEFT JOIN user_role i ON h.user_role = i.id AND upper(i.name::text) = 'ADMINISTRATOR'::text
  WHERE lower(a.follower_entity_type::text) = 'user'::text AND lower(a.following_entity_type::text) = 'user'::text
UNION ALL
 SELECT a.follower_id AS source_id,
    b.first_name AS source_name,
    f.file_name AS source_icon_path,
   ...
   FROM follow a
     ...
     LEFT JOIN users h ON e.id = h.company_id
     LEFT JOIN user_role i ON h.user_role = i.id AND upper(i.name::text) = 'ADMINISTRATOR'::text
  WHERE lower(a.follower_entity_type::text) = 'user'::text AND lower(a.following_entity_type::text) = 'product'::text
UNION ALL
 SELECT a.follower_id AS source_id,
    b.first_name AS source_name,
    f.file_name AS source_icon_path,
   ...
   FROM follow a
     ...
     LEFT JOIN user_role i ON h.user_role = i.id AND upper(i.name::text) = 'ADMINISTRATOR'::text
  WHERE lower(a.follower_entity_type::text) = 'user'::text AND lower(a.following_entity_type::text) = 'company'::text
UNION ALL
 SELECT a.follower_id AS source_id,
   ...
   FROM follow a
     ...
     LEFT JOIN users h ON e.id = h.company_id
     LEFT JOIN user_role i ON h.user_role = i.id AND upper(i.name::text) = 'ADMINISTRATOR'::text
  WHERE lower(a.follower_entity_type::text) = 'company'::text AND lower(a.following_entity_type::text) = 'user'::text
UNION ALL
 SELECT a.follower_id AS source_id,
    c.name AS source_name,
    f.file_name AS source_icon_path,
   ...
   FROM follow a
     ...
     LEFT JOIN users h ON e.id = h.company_id
     LEFT JOIN user_role i ON h.user_role = i.id AND upper(i.name::text) = 'ADMINISTRATOR'::text
  WHERE lower(a.follower_entity_type::text) = 'company'::text AND lower(a.following_entity_type::text) = 'product'::text
UNION ALL
 SELECT a.follower_id AS source_id,
    c.name AS source_name,
    f.file_name AS source_icon_path,
   ...
   FROM follow a
     ...
     LEFT JOIN users h ON d.id = h.company_id
     LEFT JOIN user_role i ON h.user_role = i.id AND upper(i.name::text) = 'ADMINISTRATOR'::text
  WHERE lower(a.follower_entity_type::text) = 'company'::text AND lower(a.following_entity_type::text) = 'company'::text;