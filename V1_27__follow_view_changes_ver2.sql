...
a.following_id targer_id,d.first_name target_name,g.file_name target_icon_path,a.following_entity_type target_type,null target_product_name
...
UNION ALL
SELECT a.follower_id source_id,b.first_name source_name,f.file_name source_icon_path,a.follower_entity_type source_type,'Admin' source_user,c.location source_location,
e.id targer_id,e.name target_name,g.file_name target_icon_path,a.following_entity_type target_type,d.name target_product_name
FROM follow a LEFT OUTER JOIN users b
ON (a.follower_id = b.id)
LEFT OUTER JOIN company c
ON(b.company_id = c.id)
...
UNION ALL
SELECT a.follower_id source_id,b.first_name source_name,f.file_name source_icon_path,a.follower_entity_type source_type,'Admin' source_user,c.location source_location,
a.following_id targer_id,d.name target_name,g.file_name target_icon_path,a.following_entity_type target_type,null target_product_name
FROM follow a LEFT OUTER JOIN users b
ON (a.follower_id = b.id)
LEFT OUTER JOIN company c
ON(b.company_id = c.id)
